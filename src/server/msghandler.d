...
final class MessageHandler
{
    ...
    bool handle_message(User user, uint code, const(ubyte)[] msg_buf)
    {
        ...
        case PrivateRoomAddUser:
            ...
            user.grant_room_membership(msg.room_name, msg.username);
            break;
        ...
        case PrivateRoomRemoveUser:
            ...
            if (msg.username != user.username)
                user.cancel_room_membership(msg.room_name, msg.username);
            break;
        ...
        case PrivateRoomCancelMembership:
            ...
            user.cancel_room_membership(msg.room_name, user.username);
            break;
